...
/** 缓存路径 */
#define LYCacheFilePath [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) firstObject] stringByAppendingPathComponent:@"default"]
...
//            [NSThread sleepForTimeInterval:5.0];
            ...
            double unit = 1000.0;
            // 缓存大小
            unsigned long long fileSize = LYCacheFilePath.fileSize;
            // 标签文字
...
- (void)clearCache
{
    ...
    [[[NSOperationQueue alloc] init] addOperationWithBlock:^{
        // 删除缓存文件夹
        [[NSFileManager defaultManager] removeItemAtPath:LYCacheFilePath error:nil];
